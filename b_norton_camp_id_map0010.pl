/opt/etl/prd/etl/APP/ADW/B_NORTON_CAMP_ID_MAP/bin> cat b_norton_camp_id_map0010.pl
######################################################
...
my $TARGET_TABLE = "NORTON_CAMP_ID_MAP";

#my $SOURCE_DB = "$etlvar::TMPDB";
my $SOURCE_DB = "MIG_ADW";

my $SOURCE_TABLE = "D_NORTON_CAMP_ID_MAP";
